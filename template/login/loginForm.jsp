...
<head>
    ...
    <link rel="stylesheet" href="login_view.css">
</head>
<body>
    <div class="container">
        ...
        <div class="container d-flex content-container">
            <div id="right-div" class="d-flex justify-content-center align-items-center">
                ...
                <h1 class="text-center">로그인</h1>
                    ...
                    <div>
                       <input type="button" id="btn" style="margin-top: 25px; width: 100%;" value="로그인" onclick="login()" class="btn btn-primary">
                       <input type="button" id="btn" style="margin-top: 25px; width: 100%;" value="회원가입" onclick="userCreate('/user/register')" class="btn btn-secondary">
                    </div>
                    </div>
                </form>
            </div>
